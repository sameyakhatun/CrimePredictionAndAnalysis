...
def women():
	...
	df = pd.read_csv("dataset/StateWiseCAWPred1990-2016.csv", header=None)
...
def children():
	...
	#reading CSV file.
	df = pd.read_csv("dataset/Statewise Cases Reported of Crimes Committed Against Children 1994-2016.csv", header=None)
...
def ipc():
	...
	#reading CSV file.
	df = pd.read_csv("dataset/StateIPCPred2001_16.csv", header=None)
...
def sll():
	...
	#reading CSV file.
	df = pd.read_csv("dataset/StateSLLPred2001_16.csv", header=None)
